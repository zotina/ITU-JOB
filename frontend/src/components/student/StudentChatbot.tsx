...
const StudentChatbot = () => {
  ...
  const handleUserSendMessage = () => {
    const inputElement = document.getElementById('student-chat-input') as HTMLInputElement;
  ...
  useEffect(() => {
    if ((currentAction === 'redirect_to_create_offer' || currentAction === 'show_create_offer_link') && actionData && actionData.redirect) {
      // Effectuer la redirection vers la page de création d'offre avec les paramètres pré-remplis
      // Note: Cette action ne devrait normalement pas se produire dans le chatbot étudiant
    }
